...
Usage:
    python alignment_demo.py <audio_path> <surah_id>
    
Examples:
    python alignment_demo.py ../Quran/badr_alturki_audio/114.wav 114
    python alignment_demo.py ../Quran/badr_alturki_audio/001.wav 1
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print()
        print("Usage:")
        print("  python alignment_demo.py <audio_path> <surah_id>  # Full test with transcription")
        print("  python alignment_demo.py --existing <surah_id>    # Test with existing segments")
        print("  python alignment_demo.py --core                   # Test core functions only")
        print()
        print("Examples:")
        print("  python alignment_demo.py ../../Quran/badr_alturki_audio/001.wav 1   # Al-Fatiha (7 ayahs)")
        print("  python alignment_demo.py ../../Quran/badr_alturki_audio/062.wav 62  # Al-Jumu'ah (11 ayahs)")
        print("  python alignment_demo.py --existing 67                               # Use existing data")
        print("  python alignment_demo.py --core                                      # Test core only")
        sys.exit(0)
